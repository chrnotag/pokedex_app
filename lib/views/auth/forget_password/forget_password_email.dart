            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text("Vamos recuperar!", style: context.textTheme.displaySmall!.copyWith(fontSize: AppSizes.textDisplaySmall.sp),),
                      Padding(
                        padding: EdgeInsets.only(bottom: 24.h),
                        child: Text("Qual é o seu e-mail?", style: context.textTheme.displayMedium!.copyWith(fontSize: AppSizes.textDisplaySmall.sp),),
                      ),
                      TextfieldCustom(hintText: "E-mail", controller: _emailController),
                      Padding(
                        padding: EdgeInsets.only(top: 8.h),
                        child: Text("Vamos enviar um código de verificação para o seu e-mail.", style: context.textTheme.bodySmall!.copyWith(fontSize: AppSizes.textBodySmall.sp), textAlign: TextAlign.center,),
                      )
                    ],
                  ),
                ),
