...
class _ForgetPasswordCodeState extends State<ForgetPasswordCode> {
  ...
  final List<FocusNode> _focusNodeList = List.generate(6, (index) => FocusNode());
                          ...
                          text: TextSpan(
                            children: [
                              ...
                              TextSpan(
                                  text: emailUser,
                                  style: context.textTheme.bodySmall!
                                      .copyWith(fontWeight: FontWeight.bold, color: MainColorsLight.textBody)),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Row(
                          ...
                          children: List.generate(6, (index) {
                            return _TextfieldOtpCode(
                              ...
                              onChanged: (value) =>  index < 5 ? value.isNotEmpty
                                  ? FocusScope.of(context).nextFocus()
                                  : index == 0 ? null : FocusScope.of(context).previousFocus() : value.isNotEmpty
                                  ? null
